...
np.save('long_roful_reg',reg_roful_trials)
np.save('long_gnop_reg',reg_gnop_trials)
np.save('long_roful_viol',viol_roful_trials)
np.save('long_gnop_viol',viol_gnop_trials)
